...
import Image1 from '../assets/image/web/news1.jpg';
import Image2 from '../assets/image/web/news2.jpg';
import Image3 from '../assets/image/web/news3.jpg';
import Image4 from '../assets/image/web/news4.jpg';
import Image5 from '../assets/image/web/news5.jpg';
import Image6 from '../assets/image/web/news6.jpg';
import Image1Webp from '../assets/image/web/news1.webp';
import Image2Webp from '../assets/image/web/news2.webp';
import Image3Webp from '../assets/image/web/news3.webp';
import Image4Webp from '../assets/image/web/news4.webp';
import Image5Webp from '../assets/image/web/news5.webp';
import Image6Webp from '../assets/image/web/news6.webp';
...
const News = () => {
    ...
    const newsList = [
        {
            id: 1,
            source: { name: "batdongsan.com.vn", url: "https://batdongsan.com.vn/phan-tich-danh-gia/thi-truong-bat-dong-san-2025-se-dien-bien-theo-kich-ban-nao-cd-hcm-826972" },
        ...
        {
            id: 2,
            source: { name: "tienphong.vn", url: "https://tienphong.vn/bat-dong-san-trung-tam-tphcm-2025-du-bao-xu-huong-va-trien-vong-post1719494.tpo" },
        ...
        {
            id: 4,
            source: { name: "doanhnghiephoinhap.vn", url: "https://doanhnghiephoinhap.vn/nhung-xu-huong-nao-se-dan-dat-thi-truong-bat-dong-san-2025-90531.html" },
            title: "Chính sách vay mua nhà mới",
            image: Image4,
            imageWebp: Image4Webp,
            content: "Ngân hàng công bố chính sách vay ưu đãi lãi suất thấp cho người mua nhà lần đầu trong năm 2025...",
            detail: "Chính phủ đã có những chính sách tích cực để thúc đẩy thị trường bất động sản phát triển ổn định và bền vững trong những năm tới. Trong năm 2024, Chính phủ sẽ tiếp tục áp dụng các chính sách hỗ trợ tín dụng cho thị trường bất động sản, đặc biệt là cho các dự án nhà ở xã hội và nhà ở cho người có thu nhập thấp. Một trong những chính sách nổi bật là việc tiếp tục triển khai chương trình hỗ trợ vay vốn ưu đãi cho các dự án nhà ở giá rẻ. Điều này giúp giải quyết nhu cầu nhà ở cho một lượng lớn người dân tại các thành phố lớn như Hà Nội và TP.HCM, đồng thời thúc đẩy thị trường bất động sản phát triển một cách ổn định.",
        },
        {
            id: 5,
            source: { name: "kinhtedouong.vn", url: "https://kinhtedouong.vn/tiem-nang-cho-phan-khuc-bat-dong-san-nghi-duong-trong-nam-2025-104471.html" },
            title: "Phân khúc nghỉ dưỡng hồi phục",
            image: Image5,
            imageWebp: Image5Webp,
