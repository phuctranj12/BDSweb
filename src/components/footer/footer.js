...
const COMPANY = [
    ...
    { to: '/Policy', label: 'Chính sách bảo mật' },
    { to: '/Policy', label: 'Chính sách đặt cọc' },
    { to: '/Policy', label: 'Chính sách hoàn trả' },
    { to: '/Policy', label: 'Chính sách hỗ trợ' },
    { to: '/Policy', label: 'Giải quyết khiếu nại' },
];
                ...
                <div className="site-footer__top">
                    ...
                    <div className="site-footer__col">
                        ...
                        <address className="site-footer__address">
                            Công ty TNHH Trường Phát Từ Sơn<br />
                            Lô F26, khu đô thị Phú Điền, phố Chùa Dận,<br />
                            phường Đình Bảng, TP. Từ Sơn, Bắc Ninh
                            <br /><br />
                            Mã số thuế: <span className="tabular">2300324841</span>
                        </address>
                    </div>
                </div>
